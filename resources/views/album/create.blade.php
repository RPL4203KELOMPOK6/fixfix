            ...
            <form role="form" action="/admin/dataalbum" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Album">
                ...
                <div class="form-group">
                    <div class="input-group">
                        ...
                        <input type="text" id="penyanyi" name="penyanyi" class="form-control" placeholder="Nama Penyanyi">
