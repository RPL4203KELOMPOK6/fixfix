...
<body>
        ...
        <div class="collapse navbar-collapse  navbar-nav navbar-center mx-auto" id="navbarSupportedContent">
            <form class="form-inline my-2 mx-auto  my-lg-0">
                <div class="input-group">
                    <input class="form-control py-0  search-bar border border-dark rounded-pill"
                        id="example-search-input">
                    <span class="input-group-append">
                        <button id="filtersubmit" class="border-0"><i
                                class="fa fa-search search-icon text-body"></i></button>
            ...
            <ul class="navbar-nav">
                <li class="nav-item active mx-md-3 mx-0">
                    <a class="nav-link d-flex" href="/cart"><img src="{{asset('assets/img/Group.png')}}"><span
                            class="d-block text-body mt-1 ml-2 font-weight-bold d-md-none">Cart</span></a>
                </li>
                <li class="nav-item mx-md-3 mx-0">
                    <a class="nav-link d-flex" href="#"><img src="{{asset('assets/img/favorite-24px 1.png')}}"
                            alt=""><span
                            class="d-block  text-body mt-1 ml-2 font-weight-bold d-md-none">Favorite</span></a>
                </li>
                <li class="nav-item mx-md-3 mx-0">
                    <a class="nav-link d-flex" href="#"><img
                            src="{{asset('assets/img/clarity_notification-solid-badged.png')}}" alt=""><span
                ...
                <li class="nav-item dropdown mx-md-3 mx-0">
                    ...
                    <div class="dropdown-menu p-4" aria-labelledby="navbarDropdown">
                        <div class="d-flex shadow-sm align-item-center rounded-small p-2">
                            <img src="{{asset('assets/img/account.png')}}" class="photo-profile rounded-circle" alt="">
                            <span class="text-gray ml-3 font-weight-bold"><a
                                    href="/profile">{{ Auth::user()->name }}</a></span>
                        </div>
                        <a href="#">
                        ...
                        <a class="dropdown-item" href="{{ route('logout') }}"
                            ...
                            <p class="text-gray font-weight-bold text-right mt-4 cursor-pointer">
                                {{ __('Logout') }}<i class="ml-1 fa fa-sign-out-alt"></i></p>
                        </a>
            ...
            <li class="nav-item mx-md-3  mx-0">
                <a class="nav-link font-weight-bold form-font text-body register-button mt-1 text-center"
    ...
    <ul class="nav justify-content-center primary-bg">
        ...
        <li class="nav-item mx-md-4">
            <a class="nav-link  text-white font-weight-bold dropdown-toggle " data-toggle="dropdown" href="#"
                role="button" aria-haspopup="true" aria-expanded="false" href="#">Kategori</a>
            <div class="dropdown-menu category-menu primary-bg dropdown-menu-right pb-5 px-3" style="left: -130px;">
                ...
                <a class="d-block bg-black mt-3 px-3 py-1 rounded text-white font-weight-bold" href="#">Favourite Album
                </a>
